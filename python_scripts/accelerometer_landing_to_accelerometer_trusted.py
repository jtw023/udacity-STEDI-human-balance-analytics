...
'''
SQLRemoveNonConsent_node1717489716736 = sparkSqlQuery(glueContext, query = SqlQuery1490, mapping = {"myDataSource":AccelerometertoCustomerJoin_node1717488816137}, transformation_ctx = "SQLRemoveNonConsent_node1717489716736")

# Script generated for node Accelerometer Trusted
AccelerometerTrusted_node1717488080223 = glueContext.write_dynamic_frame.from_options(frame=SQLRemoveNonConsent_node1717489716736, connection_type="s3", format="json", connection_options={"path": "s3://jwawss3testbucket/accelerometer/trusted/", "partitionKeys": []}, transformation_ctx="AccelerometerTrusted_node1717488080223")
